    ...
    return (
        <header className={`${headerStyles.header} pb-4 pt-4 mt-10`}>
            <div className={`${headerStyles.headerBlock}`}>
                <NavLink to="/" className={`${headerStyles.header_item_wrapper_item} pl-5 pr-5 pb-4 pt-4 mr-2`} onClick={() => handlerMenu("constructor")}>
                ...
                <NavLink to="/" className={`${headerStyles.header_item_wrapper_item} pl-5 pr-5 pb-4 pt-4`} onClick={() => handlerMenu("orders")}>
            ...
            <div className={`${headerStyles.headerBlock}`}>
                <NavLink to="/profile" className={`${headerStyles.header_item_wrapper_item} pl-5 pr-5 pb-4 pt-4`} onClick={() => handlerMenu("profile")}>
