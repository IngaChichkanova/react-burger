...
export const ForgotPasswordPage: FC<HTMLAttributes<HTMLHtmlElement>> = () => {
  ...
  const forgotPasswordStart = useSelector((state: { [prop in keyof TRootState as string]: any }) => state.user.forgotPasswordStart);
  const forgotPasswordError = useSelector((state: { [prop in keyof TRootState as string]: any }) => state.user.forgotPasswordError);
