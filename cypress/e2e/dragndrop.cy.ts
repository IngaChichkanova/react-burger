describe('ingredient modal', () => {
    ...
    it('drag n drop element inside the constructor', () => {
        cy.get('[data-testid=bun-section] div[draggable]').first().trigger('dragstart');
        cy.get('[data-testid=drop]').trigger('drop');
        ...
        cy.get('[data-testid=main-drop]').children().last().trigger('dragstart');
        cy.get('[data-testid=main-drop]').children().first().trigger('drop');
